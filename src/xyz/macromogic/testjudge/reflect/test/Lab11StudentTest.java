...
public class Lab11StudentTest implements ReflectJudge {
    ...
    private void checkAttributes(Class<?> cls) throws TestException {
        ...
        MethodChecker.Entity[] methodEntities = {
                new MethodChecker.Entity(false, false, String.class, "getClassStatus"),
                new MethodChecker.Entity(false, false, void.class, "setClassStatus", String.class),
                ...
                new MethodChecker.Entity(false, false, String.class, "study")
        };
        try {
