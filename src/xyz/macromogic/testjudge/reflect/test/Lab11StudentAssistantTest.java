...
public class Lab11StudentAssistantTest implements ReflectJudge {
    @Override
    ...
    private void checkAttributes(Class<?> cls) throws TestException {
        ...
        FieldChecker.Entity[] fieldEntities = {
                new FieldChecker.Entity(true, true, int.class, "id")
        };
        try {
        ...
        MethodChecker.Entity[] methodEntities = {
                ...
                new MethodChecker.Entity(false, false, false, String.class, "work")
        };
        try {
